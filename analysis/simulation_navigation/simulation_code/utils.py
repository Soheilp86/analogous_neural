...
def get_spikes(rat_name, mod_name, day_name = '', sess_name = '', bType = None, bSmooth = True, 
    ...
    if np.str.upper(rat_name) == 'R':
        f = np.load('rat_r_' + day_name + '_grid_modules_1_2_3.npz', allow_pickle = True)
    elif np.str.upper(rat_name) == 'Q':
        f = np.load('rat_q_grid_modules_1_2.npz', allow_pickle = True)
    elif np.str.upper(rat_name) == 'S':
        f = np.load('rat_s_grid_modules_1.npz', allow_pickle = True)
    else:
