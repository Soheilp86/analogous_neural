# THIS IS A COPY OF EIRENE with slight modification by Iris Yoon (iris.hr.yoon@gmail.com). 
# Current version of Eirene (July 19, 2022) contains error when `boundarymatrix`.
# This variation of EIRENE fixes the typo in line 4944. A pull request has been created for Eirene.
